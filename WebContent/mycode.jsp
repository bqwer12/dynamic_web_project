...
/*///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
  ...
  <div class="collapse navbar-collapse" id="navbarColor03">
    ...
    String sql = "select id,jsonobj,title FROM feed WHERE id = '" + id + "'";
	...
	int i=1;
      ...
      <div class="content">
         ...
         <div class="mylist" align="center">
            ...
            <%
            while(rs.next()){ if(i>0){%>
            	<script>
            	function view<%=i%>() {
                    if(user_content_<%=i%>.style.display=="none") {
                      user_content_<%=i%>.style.display="block";
                      
                    }
                    else {
                      user_content_<%=i%>.style.display="none";
            ...
            %>
            <div class="user_list">
               <div class="item" id="item_No" style=" width: 10%; padding-left: 5px;"><%=i %></div>
               <div class="item" id="item_Name" style=" width: 50%;"><%=name%></div>
               <%if(i>0){ %>
               <div class="item" id="item_More_<%=i %>" style=" width: 15%;" id="code1" onclick="view<%=i%>()">more</div>
               
            </div>
            <div class="user_conL" id="user_content_<%=i %>" style="display:none; width:60%;">
                        <%=code %>
            </div> 
            <%}%>  
                     ...
                     <% i++;}
            if( i==1){
            	out.print("<div class="+"user_conL" +"style="+"display:none; width:60%;"+">등록된 코딩이 없습니다.</div>");
            }
